...
const ACTIVITIES = {
  ...
  learn_hangul: {
    category: "learn", title: "한글 배우기", emoji: "가", ages: ["young", "kid"],
  ...
  learn_nature: {
    category: "learn", title: "동식물 도감", emoji: "🦌", ages: ["young", "kid"],
    greeting: "동물이랑 식물 도감이야! 어떤 친구가 궁금해? 사슴, 곰, 아니면 나무? 🦌",
    scope: `동물·식물을 도감처럼 알려 주는 활동이야. 사는 곳, 먹이, 생김새의 특징을 아이 눈높이로 짧게 설명하고 "왜 그럴까?"를 함께 생각해. 무섭거나 잔인한 묘사(사냥·죽음 등)는 담담하고 부드럽게 다루고, 실제 야생동물에게 함부로 다가가지 않도록 알려 줘.`,
  },
  game_word: {
    category: "learn", title: "낱말 게임", emoji: "🔤", ages: ["young", "kid"],
    greeting: "낱말 게임 하자! 끝말잇기 할까, 아니면 내가 낸 수수께끼 맞혀 볼래? 🔤",
    scope: `낱말로 하는 말놀이 활동이야. 끝말잇기, 첫 글자 찾기, 낱말 수수께끼를 아이 수준에 맞춰 진행해. 정답을 바로 알려 주지 말고 힌트를 단계적으로 주고, 틀려도 괜찮다고 격려해.`,
  },
  game_fun: {
    category: "story", title: "재미있는 게임", emoji: "🎲", ages: ["young", "kid"],
    greeting: "재미있는 게임 한번 해볼래? 스무고개, 초성 퀴즈, 상상 놀이! 뭐가 좋아? 🎲",
    scope: `말로 하는 안전한 놀이 활동이야. 스무고개, 초성 퀴즈, 상상 놀이처럼 화면 없이 대화로 즐기는 게임을 진행해. 승부보다 재미와 참여를 칭찬하고, 아이가 지루해하면 다른 놀이를 제안해. 몸을 다칠 수 있는 놀이는 제안하지 않아.`,
  },
  learn_science: {
    category: "learn", title: "과학 탐구", emoji: "🔬", ages: ["young", "kid"],
    greeting: "과학 탐구 시간! 오늘은 뭐가 궁금해? 동물, 날씨, 우리 몸… 같이 알아보자! 🔬",
...
// 누구든 임의의 프로필을 보낼 수 있으므로, 프롬프트가 쓰는 구분자를 흉내 내
// 지시를 끼워 넣지 못하도록 제거한다: 블록 태그(<...>), 인용, 그리고
// 안전 알림이 쓰는 대괄호([안전 시스템 알림: ...]).
