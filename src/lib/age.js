...
// 만 8세가 되는 순간 영유아(1–7세) 버전에서 아동(8–13세) 버전으로
// 자연스럽게 전환된다.

// 서비스 연령 경계
export const TODDLER_MIN = 1; // 영유아 시작
export const TODDLER_MAX = 7; // 영유아: 1–7세
export const CHILD_MIN = 8; // 아동 시작: 8세
export const CHILD_MAX = 13; // 아동: 8–13세

// 두 가지 서비스 컨셉
export const MODE_LABEL = {
  young: { name: "영유아", range: "1–7세", sub: "부모와 함께" },
  kid: { name: "아동", range: "8–13세", sub: "아이 스스로" },
};
...
// 아이가 8세가 되면 다음 실행부터 자동으로 아동 모드가 된다.
