...
- **SpicyTalk 스타일 홈 화면** — 히어로 배너 캐러셀, 인기 친구 카드, 하단 탭 바(홈/대화/보호자)
- **캐릭터 일러스트** — 각 친구를 인라인 SVG 마스코트로 표현 (외부 이미지 없이 자체 완결형)
- **캐릭터 선택** — 6명의 AI 친구 중 골라서 대화 (캐릭터별 대화 기록 분리)
  - ⭐ **별이**: 뭐든지 함께하는 만능 친구 (말놀이, 수수께끼, 고민 들어주기)
  - 🦕 **디노 박사**: 공룡·동물·과학 척척박사
  - 🚀 **루나**: 우주 탐험 역할놀이 대장
  - 🧚 **모모**: 함께 이야기를 짓는 꼬마 요정
  - 🎵 **멜로디**: 노래·리듬 놀이 음악 친구
